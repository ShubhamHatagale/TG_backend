const Drishti = require('../models/drishti.model');
...
exports.postRecords = async (req, res, next) => {
  try {
    const DrishtiData = await Drishti.create({
      drishti_parameter: req.body.drishti_parameter,
      year_1: req.body.year_1,
      year_2: req.body.year_2,
      year_3: req.body.year_3,
      year_4: req.body.year_4,
      year_5: req.body.year_5,
